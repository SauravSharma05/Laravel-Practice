...
<body>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <input type="text" class="form-control" readonly id="name" name="name" value="{{$data->name}}" placeholder="Client Name">
        </div>
            <div class="mb-3">
            <input type="number" class="form-control" readonly placeholder="Mobile No." id="mobile" value="{{$data->mobile}}" name="mobile">
        </div>
        <div class="mb-3">
            <input type="text" class="form-control" readonly placeholder="Mortgager Name" id="mortname" value="{{$data->mortname}}" name="mortname">
        </div>
        <div class="mb-3">
            <input type="text" class="form-control" readonly placeholder="Mortgager Mobile no." id="mortnumber" value="{{$data->mortnumber}}" name="mortnumber">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-3">
            <input type="text" readonly class="form-control" value="{{$data->wit1name}}" placeholder="Witness 1 Name." id="wit1name" name="wit1name">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-3">
            <input type="text" readonly class="form-control" value="{{$data->wit2name}}" readonly placeholder="Witness 2 Name." id="wit2name" name="wit2name">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-3">
            <input type="text" readonly class="form-control" value="{{$data->borname}}" readonly placeholder="Borrower Name" id="borname" name="borname">
        </div>
        <br>
        <div class="mb-3">
